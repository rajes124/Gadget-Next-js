        ...
        <div className="glass-effect rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full gradient-btn text-white py-3 rounded-lg font-bold disabled:opacity-50 flex items-center justify-center gap-2 hover:shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl disabled:scale-95 animate-slide-in-up"
          ...
          <div className="mt-6 space-y-3 animate-fade-in" style={{ animationDelay: '0.5s' }}>
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-700 text-gray-900 dark:text-white px-4 py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 border-2 border-gray-200 dark:border-gray-600 disabled:opacity-50 transform hover:scale-105 hover:shadow-2xl disabled:scale-95"
            >
              {googleLoading ? (
                <>
                ...
                <>
                  <div className="relative w-5 h-5 transform group-hover:scale-110 transition-transform duration-300">
                    <Image
