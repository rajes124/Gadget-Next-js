      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {featured.map((item: any, idx: number) => (
            ...
            >
              {/* Image Container - ItemsPage-এর মতো */}
              <div className="bg-gray-200 dark:bg-gray-700 h-64 flex items-center justify-center overflow-hidden relative">
                ...
                {/* Overlay on Hover - ItemsPage-এর মতো */}
                <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-30 transition-opacity duration-300"></div>
              </div>

              {/* Content - ItemsPage-এর মতো layout */}
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4 text-sm group-hover:text-gray-500 transition-colors duration-300">
                  {item.description}
                </p>
                ...
                {/* Price and Button - ItemsPage-এর মতো */}
