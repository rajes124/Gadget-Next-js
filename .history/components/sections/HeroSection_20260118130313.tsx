      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight animate-slide-in-down">
            <span className="inline-block gradient-text text-6xl md:text-8xl font-black drop-shadow-lg">Discover Smart Gadgets</span>
            <br />
            <span className="text-white text-5xl md:text-7xl">for a Smarter Life</span>
          </h1>
