      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {featured.map((item: any, idx: number) => (
            <div 
              key={item.id} 
              className="glass-effect rounded-2xl overflow-hidden transition-all duration-500 ease-out group hover:shadow-2xl hover:scale-[1.03] hover:-translate-y-3 hover:rotate-[0.5deg] animate-slide-in-up relative flex flex-col"
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                {item.image ? (
                  ...
                  <Smartphone className="w-32 h-32 text-gray-400 opacity-80 transition-transform duration-500 group-hover:scale-110" />
                )}
              ...
              <div className="p-6 relative z-10 flex flex-col flex-grow">
                ...
                <div className="flex justify-between items-center mt-auto">
                  ...
                  <Link
                    href={`/items/${item.id}`}
                    className="gradient-btn text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:shadow-xl transition-all duration-300 flex items-center gap-2 transform hover:scale-105 active:scale-95"
                  >
