        ...
        <div className="grid md:grid-cols-4 gap-6">
          {categories.map((cat, idx) => {
            ...
            return (
              <div
                key={cat.name}
                className="group glass-effect p-8 rounded-2xl text-center cursor-pointer hover:scale-110 hover:shadow-2xl transition-all duration-300 transform animate-slide-in-up"
                style={{ animationDelay: `${idx * 0.1}s` }}
              >
                <div className={`inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-r ${cat.color} mb-4 group-hover:shadow-lg transition-all`}>
