      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {featured.map((item: any, idx: number) => (
            <div 
              key={item.id} 
              className="glass-effect rounded-2xl overflow-hidden transition-all duration-500 ease-out group hover:shadow-2xl hover:scale-[1.03] hover:-translate-y-3 hover:rotate-[0.5deg] animate-slide-in-up relative"
