...
export default function ProfilePage() {
  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      ...
      // Try to save to backend (live Render URL)
      try {
        const response = await fetch('https://gadget-backend-server.onrender.com/api/users/update', {
          method: 'POST',
          headers: {
        ...
        if (response.ok) {
          ...
          console.warn('Backend update failed, but local update done');
