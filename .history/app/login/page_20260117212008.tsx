    ...
    <div className="min-h-screen flex items-center justify-center px-4 pt-20">
      <div className="w-full max-w-md">
        <div className="glass-effect rounded-2xl p-8">
          ...
          <div className="mt-6 space-y-3">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-slate-900 text-gray-600 dark:text-gray-400">Or</span>
              </div>
            </div>
          ...
          <div className="mt-6 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg text-sm text-center">
            <p className="text-gray-700 dark:text-gray-300">
              <strong>Demo Credentials:</strong><br />
              Email: admin@gadgethub.com<br />
              Password: 123456
            </p>
          </div>
        </div>
