        ...
        <div className="glass-effect rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
          ...
          <div className="mt-6 space-y-3 animate-fade-in" style={{ animationDelay: '0.5s' }}>
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-700 text-gray-900 dark:text-white px-4 py-3 rounded-lg font-semibold hover:shadow-lg transition border-2 border-gray-200 dark:border-gray-600 disabled:opacity-50"
            >
              {googleLoading ? (
                <>
