...
import { ShoppingCart } from 'lucide-react'; // icon import করলাম (যদি না থাকে, তোমার project-এ lucide-react install করা আছে ধরে নিচ্ছি)
            ...
            {filteredItems.map((item, idx) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* Price and Button - fixed layout */}
                  <div className="flex flex-col gap-4 mt-4">
                    <span className="text-3xl font-bold gradient-text self-start group-hover:scale-110 transition-transform duration-300 origin-left">
                      ${item.price}
                    </span>
                    <Link
                      href={`/items/${item.id}`}
                      className="gradient-btn text-white px-5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg flex items-center justify-center gap-2 w-full md:w-auto"
                    >
