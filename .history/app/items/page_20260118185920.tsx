        ...
        <div className="glass-effect p-6 rounded-2xl mb-8 animate-fade-in">
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full pl-10 px-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-700 dark:bg-slate-800 focus:border-purple-500 focus:outline-none transition"
            />
            {searchTerm && (
              <button
