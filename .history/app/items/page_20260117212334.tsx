...
const DEMO_ITEMS = [
  { id: '1', name: 'iPhone 15 Pro', price: 1500, category: 'Smartphones', description: 'Latest Apple flagship with advanced camera' },
  { id: '2', name: 'MacBook Pro 16"', price: 2500, category: 'Laptops', description: 'Powerful laptop with M3 Max chip' },
  { id: '3', name: 'Apple Watch Ultra 2', price: 800, category: 'Wearables', description: 'Advanced smartwatch with health features' },
  { id: '4', name: 'Sony WH-1000XM5', price: 400, category: 'Accessories', description: 'Noise-canceling wireless headphones' },
  { id: '5', name: 'iPad Pro 12.9"', price: 1200, category: 'Tablets', description: 'Premium tablet with M2 chip' },
  { id: '6', name: 'Samsung Galaxy S24', price: 1000, category: 'Smartphones', description: 'Latest Samsung flagship smartphone' },
];
