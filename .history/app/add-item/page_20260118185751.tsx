...
export default function AddItemPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Save to backend
      const response = await fetch('https://gadget-backend-server.onrender.com/api/items', {
        method: 'POST',
        headers: {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 gradient-btn text-white py-3 rounded-lg font-bold disabled:opacity-50 transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center gap-2 disabled:scale-95"
              >
                {loading ? (
                  <>
              ...
              <button
                ...
                className="flex-1 border-2 border-purple-600 text-purple-600 py-3 rounded-lg font-bold hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
              >
                Cancel
              </button>
            </div>
